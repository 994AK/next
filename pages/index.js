    ...
    return <animated.div style={props}>
        <div className={`${styles.container} mt-20 w-full`}>
            <main className={`${styles.main}`}>
                ...
                <div className='text-3xl flex justify-center text-red-600 md:text-2xl mt-2 mb-2 md:w-1/2'>点击头像或名字查询统计信息 </div>
                ...
                <div className='mt-2 flex-wrap w-5/6 '>
                    <Players sample={data.data.players?.sample ? data.data.players?.sample : []  }/>
                </div>
