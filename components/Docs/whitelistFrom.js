      ...
      <div>
        <div onClick={handleClickClosureWindow} className="flex justify-end p-5">
          <svg
            ...
            className="h-5 w-5 text-white cursor-pointer hover:text-neutral-200"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
            strokeWidth={2}
          ...
          <div className="flex justify-center flex-col">
            <label className="flex mt-3">
              ...
              <div className="flex-1 flex flex-col md:h-16 ">
                ...
                />
                {validationFrom.email.state && (
                  <span className="text-red-600 md:mt-1 md:ml-3">{validationFrom.email.msg}</span>
                )}
              </div>
            </label>
            <label className="flex mt-5">
              ...
              <div className="flex-1 mr-3 flex flex-col md:h-16">
                ...
                {validationFrom.code.state && (
                  <span className="text-red-600 md:mt-1 md:ml-3">{validationFrom.code.msg}</span>
                )}
              </div>
              <div
                className="w-30 text-xs mt-1.5 pr-3 md:text-base md:mt-2 md:pr-0"
            ...
            <div className="flex justify-center items-center mt-7">
              <button
                ...
                className="w-28 h-10 border-2 border-gray-400 rounded-md hover:border-gray-600"
              >
                提交
              </button>
            </div>
