...
import {  CheckOutlined, ArrowRightOutlined, CloseOutlined, ExclamationOutlined} from "@ant-design/icons";
    ...
    >
        ...
        <div className='flex justify-start'>
            <div className='flex items-end'>
                ...
                <div className='flex items-end pb-1 pl-1 text-neutral-200'><ArrowRightOutlined/></div>
            </div>
        </div>
    </div>
}